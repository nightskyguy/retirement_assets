...
const PLAN = {
    ...
    notes: {
        ...
        origin: "READ BY `ssbasis_harness.js`, `ssbasis_arms_harness.js` and `underfill_harness.js` (that one over 20 years instead of 30, its only difference), all three retired in P116. Extracted from the literal all three carried separately; the refit was verified by diffing each harness's output before and after.",
    },
    inputs: {
        STATEname: "TX",
        nYears: 30,
