...
| `.test_harnesses/rmdbasis_harness.js` | `node` investigative script for P84 — characterizes the RMD basis before and after `P84l`, and scores whether the fix moved what the characterization predicted. Report: `research/RMDBASIS_RESULTS.md`. |
| `.test_harnesses/convtiming_harness.js` | `node` investigative script for P85 — front-load vs level vs back-load Roth conversion schedules at equal lifetime gross. Report: `research/CONVTIMING_RESULTS.md`. |
