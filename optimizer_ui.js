...
function updateTable(log) {
    ...
    const tooltips = {
        ...
        'IRA1-': 'Voluntary withdrawals from IRA1 this year: the spending draw plus any Roth conversions sourced from IRA1. Conversions are taken from the larger IRA first, so a conversion always appears here as a withdrawal. Excludes RMD (see RMD1-).',
        'IRA2-': 'Voluntary withdrawals from IRA2 this year: the spending draw plus any Roth conversions sourced from IRA2 (used once the larger IRA cannot supply the full conversion). Excludes RMD (see RMD2-).',
