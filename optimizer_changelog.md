...
guard fired exactly as designed and the indicator read "test counts changed" with the console
...
- **[README.md](README.md) now explains Monte Carlo and "Chance of Success" properly.** A new
  section walks through what a Monte Carlo simulation is doing, why results from two different
  ...
  percentage.
- **The tax-withholding maneuver section gains "the *other* maneuver"**: using the once-per-year
