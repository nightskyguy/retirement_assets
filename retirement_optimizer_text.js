...
howToUse: `  
	<div class="log-entry"><ul>
		...
		<li><strong>Strategy:</strong> 
			...
			<ul><li>In <em>Withdraw to meet spend</em> it proportionately withdraws enough from all available sources to reach <i>After-tax Spending Goal</i>. Its a good baseline to compare with other strategies.</li>
