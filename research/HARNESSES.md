...
| `rbg_harness.js` | node | Can risk-based (probability-of-success) guardrails be computed on this engine, what do they cost, where does the shipped Guardrails rule disagree - and how far is that rule from Guyton-Klinger as published? | [RISK_BASED_GUARDRAILS.md](RISK_BASED_GUARDRAILS.md) | `1842270` |
