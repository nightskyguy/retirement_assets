...
| report | what it covers |
|---|---|
| [BRACKET_CEILING_BASIS.md](BRACKET_CEILING_BASIS.md) | A "fill the 22% bracket" strategy fills it to $179,200 of $211,400, because the ceiling is a taxable-income threshold spent as a MAGI one. The gap is exactly one deduction, confirmed to the dollar - and closing it LOSES money in 51 of 74 clean cells, because the shipped shortfall is accidentally conservative. |
