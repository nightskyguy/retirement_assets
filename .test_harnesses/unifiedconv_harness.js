 ...
 * it produced are kept in research/CONVERSION_ROUTING.md. `rothGapFill` SHIPPED, as the "Roth in shortfall
...
// asserted -- routing is label-only in all 90 cells -- is recorded in research/CONVERSION_ROUTING.md, and it can
